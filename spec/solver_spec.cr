...
describe Linprog do
  ...
  it "loads explicit problem" do
    s1 = Symphony::Solver.new
    problem = LinProg::Problem.from_dense(
  ...
  it "allows to set and get optimization direction" do
    s1 = Symphony::Solver.new
    s1.direction.should eq LinProg::Direction::Minimize
    s1.direction = LinProg::Direction::Maximize
    s1.direction.should eq LinProg::Direction::Maximize
    s1.free!
  end
